...
"""
Sin entrar en los metodos repetitivos en la creacion de las interfaces y las llamadas a funciones

La clase managePersonnel cuenta con 
El método is_current_delivery verifica si hay una entrega seleccionada actualmente.

El método create_or_update_delivery permite al usuario crear o actualizar una entrega. 

El método delete_delivery permite al usuario borrar una entrega.

El método add_to_grid agrega una etiqueta representando una entrega al área de texto desplazable.

Este metodo se adapta a las necesidades de cada ventana por lo que aunque se vea muy repetitiva en el package processes
es de suma importancia para la correcta gestion del programa

El método setup_ui configura la interfaz de usuario de la ventana, mostrando las entregas disponibles 
y permitiendo crear, actualizar o borrar entregas.
