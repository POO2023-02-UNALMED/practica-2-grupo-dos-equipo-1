...
class VentanaPrincipal(tk.Frame):
    ...
    def configure_ui(self):
        self.master.title("Ecart - Usuario")
        self.master.resizable(False, False)
        self.master.geometry("865x480+400+200")
...
ofreciendo hosting, exposición, manejo de trámites y Delivery rentable.
        ...
        bienvenida_label = Label(frame, text="Bienvenido a", font=("Arial", 14, "bold"))
        ...
        label_dibujo = Label(frame, text=self.texto_inicio, font=("Courier", 11), width=200)
        ...
        info_text = Label(frame, text=informacion, font=("Arial", 10), fg="black", bg="lightblue", width=110)
